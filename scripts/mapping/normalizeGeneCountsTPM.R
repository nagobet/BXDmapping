...
for(l in linenumberbysample){
  # load gene length
  ##gl <- read.table(paste0("F:/BXD/data/PersonalizedReferences/BXD", l, "_nonrandomized_genotypesandimputed/genelength.txt"), header=TRUE, stringsAsFactors=FALSE, row.names="gene")
  gl <- read.table(paste0("/mnt/nas/BXD/data/PersonalizedReferences/BXD", l, "_nonrandomized_genotypesandimputed/genelength.txt"), header=TRUE, stringsAsFactors=FALSE, row.names="gene")
...
##saveRDS(gene_length_matrix, "F:/BXD/data/PersonalizedReferences/GeneLengthMatrix.rds")
##saveRDS(gene_length_matrix, "/mnt/nas/BXD/data/PersonalizedReferences/GeneLengthMatrix.rds")
##gene_length_matrix <- readRDS("F:/BXD/data/PersonalizedReferences/GeneLengthMatrix.rds")
##gene_length_matrix <- readRDS("/mnt/nas/BXD/data/PersonalizedReferences/GeneLengthMatrix.rds")
