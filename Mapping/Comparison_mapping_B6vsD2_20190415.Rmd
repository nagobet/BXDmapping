...
##setwd("Z:/BXD/analyses/Comparison_mapping_B6vsD2")
...
# PCA
##PC_ratio <- prcomp(B6D2ratio)

# plot the PCA results
##plot(PC_ratio$rotation[,"PC1"], PC_ratio$rotation[,"PC2"], main="PCA of ratio", xlab="PC1", ylab="PC2", pch="")
##text(PC_ratio$rotation[,"PC1"], PC_ratio$rotation[,"PC2"], labels=rownames(t(B6D2ratio)), pos=2, offset=-2)
##boxplot.stats(PC_ratio$rotation[,"PC1"])$out
##boxplot.stats(PC_ratio$rotation[,"PC2"])$out
...
# in liver
plot("", las=2, xlim=c(1,3), ylim=c(63,82), bty="l", xaxt="n", main="Difference in mappability by reference for parental strains in liver", xlab="Reference", ylab="Uniquely mapped reads (%)")
axis(1, at=1:3, labels=c("B6mm9","B6mm10","D2"))
...
# in cortex
plot("", las=2, xlim=c(1,3), ylim=c(80,92), bty="l", xaxt="n", main="Difference in mappability by reference for parental strains in cortex", xlab="Reference", ylab="Uniquely mapped reads (%)")
axis(1, at=1:3, labels=c("B6mm9","B6mm10","D2"))
...
# in liver
plot("", las=2, xlim=c(1,3), ylim=c(9,20), bty="l", xaxt="n", main="Difference in mappability by reference for parental strains in liver", xlab="Reference", ylab="Multiply mapped reads (%)")
axis(1, at=1:3, labels=c("B6mm9","B6mm10","D2"))
...
# in cortex
plot("", las=2, xlim=c(1,3), ylim=c(1,9), bty="l", xaxt="n", main="Difference in mappability by reference for parental strains in cortex", xlab="Reference", ylab="Multiply mapped reads (%)")
axis(1, at=1:3, labels=c("B6mm9","B6mm10","D2"))
...
# in liver
plot("", las=2, xlim=c(1,3), ylim=c(7,20), bty="l", xaxt="n", main="Difference in mappability by reference for parental strains in liver", xlab="Reference", ylab="Unmapped reads (%)")
axis(1, at=1:3, labels=c("B6mm9","B6mm10","D2"))
...
# in cortex
plot("", las=2, xlim=c(1,3), ylim=c(3,14), bty="l", xaxt="n", main="Difference in mappability by reference for parental strains in cortex", xlab="Reference", ylab="Unmapped reads (%)")
axis(1, at=1:3, labels=c("B6mm9","B6mm10","D2"))
